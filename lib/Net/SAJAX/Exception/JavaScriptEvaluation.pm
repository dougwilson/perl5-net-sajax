...
This is a L<JE::Object::Error> object that contains the error that was
generated by L<JE> while evaluating a string of JavaScript.

=head2 javascript_string

B<required>

This is a string that contains the JavaScript that was being evaluated when
the error occurred.
